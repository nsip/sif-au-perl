...
package SIF::AU::Type::EmailListType_Email_SIF_Action;


our @ISA=qw(XML::Pastor::Builtin::token);

SIF::AU::Type::EmailListType_Email_SIF_Action->XmlSchemaType( bless( {
         ...
         'name' => 'EmailListType_Email_SIF_Action',
...
B<SIF::AU::Type::EmailListType_Email_SIF_Action>  -  A class generated by L<XML::Pastor> . 
