...
package SIF::AU::Type::NameOfRecordType_Type;


our @ISA=qw(XML::Pastor::Builtin::token);

SIF::AU::Type::NameOfRecordType_Type->XmlSchemaType( bless( {
...
B<SIF::AU::Type::NameOfRecordType_Type>  -  A class generated by L<XML::Pastor> . 
