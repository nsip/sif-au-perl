...
package SIF::AU::Type::SIF_EncryptionLevelType;


our @ISA=qw(XML::Pastor::Builtin::unsignedInt);

SIF::AU::Type::SIF_EncryptionLevelType->XmlSchemaType( bless( {
...
B<SIF::AU::Type::SIF_EncryptionLevelType>  -  A class generated by L<XML::Pastor> . 
