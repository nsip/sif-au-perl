...
package SIF::AU::Type::SIF3AssessmentSectionType_SectionItemSequenceType;


our @ISA=qw(XML::Pastor::Builtin::token);

SIF::AU::Type::SIF3AssessmentSectionType_SectionItemSequenceType->XmlSchemaType( bless( {
         ...
         'name' => 'SIF3AssessmentSectionType_SectionItemSequenceType',
...
B<SIF::AU::Type::SIF3AssessmentSectionType_SectionItemSequenceType>  -  A class generated by L<XML::Pastor> . 
