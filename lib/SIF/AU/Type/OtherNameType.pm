...
package SIF::AU::Type::OtherNameType;
...
SIF::AU::Type::OtherNameType->mk_accessors( qw(_Type));

# Attribute accessor aliases

sub Type { &_Type; }

SIF::AU::Type::OtherNameType->XmlSchemaType( bless( {
         'attributeInfo' => {
                              'Type' => bless( {
      ...
      "
         ...
         'class' => 'SIF::AU::Type::OtherNameType',
         'contentType' => 'complex',
         'derivedBy' => 'extension',
         'documentation' => bless( [
                                     bless( {
...
B<SIF::AU::Type::OtherNameType>  -  A class generated by L<XML::Pastor> . 
...
=item B<_Type>(), B<Type>()      - See L<SIF::AU::Type::AUCodeSetsNameUsageTypeType>.
