...
package SIF::AU::Type::SIF_ExtendedQueryDataModelType_SIF_From_SIF_Join_SIF_JoinOn_SIF_LeftElement;

use SIF::AU::Type::ObjectNameType;

our @ISA=qw(XML::Pastor::Builtin::normalizedString);

SIF::AU::Type::SIF_ExtendedQueryDataModelType_SIF_From_SIF_Join_SIF_JoinOn_SIF_LeftElement->mk_accessors( qw(_ObjectName));

# Attribute accessor aliases

sub ObjectName { &_ObjectName; }

SIF::AU::Type::SIF_ExtendedQueryDataModelType_SIF_From_SIF_Join_SIF_JoinOn_SIF_LeftElement->XmlSchemaType( bless( {
         'attributeInfo' => {
                              'ObjectName' => bless( {
         ...
         'isSimpleContent' => 1,
         'metaClass' => 'SIF::AU::Pastor::Meta',
         'name' => 'SIF_ExtendedQueryDataModelType_SIF_From_SIF_Join_SIF_JoinOn_SIF_LeftElement',
...
B<SIF::AU::Type::SIF_ExtendedQueryDataModelType_SIF_From_SIF_Join_SIF_JoinOn_SIF_LeftElement>  -  A class generated by L<XML::Pastor> . 
