...
package SIF::AU::Type::StudentSchoolEnrollmentType_StudentSubjectChoiceList_StudentSubjectChoice;
...
SIF::AU::Type::StudentSchoolEnrollmentType_StudentSubjectChoiceList_StudentSubjectChoice->mk_accessors( qw(PreferenceNumber SubjectLocalId StudyDescription OtherSchoolLocalId));

SIF::AU::Type::StudentSchoolEnrollmentType_StudentSubjectChoiceList_StudentSubjectChoice->XmlSchemaType( bless( {
         'attributeInfo' => {},
         'attributePrefix' => '_',
         'attributes' => [],
         'baseClasses' => [
         ...
         'isRedefinable' => 1,
         'metaClass' => 'SIF::AU::Pastor::Meta',
         'name' => 'StudentSchoolEnrollmentType_StudentSubjectChoiceList_StudentSubjectChoice',
...
B<SIF::AU::Type::StudentSchoolEnrollmentType_StudentSubjectChoiceList_StudentSubjectChoice>  -  A class generated by L<XML::Pastor> . 
