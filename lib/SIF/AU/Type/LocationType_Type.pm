...
package SIF::AU::Type::LocationType_Type;


our @ISA=qw(XML::Pastor::Builtin::token);

SIF::AU::Type::LocationType_Type->XmlSchemaType( bless( {
         ...
         'enumeration' => {
                            ...
                            'District' => 1,
                            'IntermediateUnit' => 1,
                            'NonInstructionalSpace' => 1,
                            'Other' => 1,
                            'School' => 1,
                            'StateEducationAgency' => 1
                          },
         'isRedefinable' => 1,
         'metaClass' => 'SIF::AU::Pastor::Meta',
         'name' => 'LocationType_Type',
...
B<SIF::AU::Type::LocationType_Type>  -  A class generated by L<XML::Pastor> . 
