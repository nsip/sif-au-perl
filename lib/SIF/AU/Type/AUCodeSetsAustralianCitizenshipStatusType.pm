...
package SIF::AU::Type::AUCodeSetsAustralianCitizenshipStatusType;


our @ISA=qw(XML::Pastor::Builtin::token);

SIF::AU::Type::AUCodeSetsAustralianCitizenshipStatusType->XmlSchemaType( bless( {
         ...
         'documentation' => bless( [
                                     ...
                                     bless( {
                                              'text' => 'New Zealand Citizen'
                                            }, 'XML::Pastor::Schema::Documentation' ),
                                     bless( {
                                              'text' => 'Permanent Resident'
                                            }, 'XML::Pastor::Schema::Documentation' ),
                                     bless( {
                                              'text' => 'Temporary Entry Permit'
                                            }, 'XML::Pastor::Schema::Documentation' ),
                                     bless( {
                                              'text' => 'Other Overseas'
                                            }, 'XML::Pastor::Schema::Documentation' ),
                                     bless( {
                                              'text' => 'Permanent Humanitarian Visa'
                                            }, 'XML::Pastor::Schema::Documentation' ),
                                     bless( {
                                              'text' => 'Not Provided'
                                            }, 'XML::Pastor::Schema::Documentation' )
         ...
         'name' => 'AUCodeSetsAustralianCitizenshipStatusType',
         'scope' => 'global',
...
B<SIF::AU::Type::AUCodeSetsAustralianCitizenshipStatusType>  -  A class generated by L<XML::Pastor> . 
