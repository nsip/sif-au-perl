...
package SIF::AU::Type::AUCodeSetsProgramFundingSourceCodeType;


our @ISA=qw(XML::Pastor::Builtin::token);

SIF::AU::Type::AUCodeSetsProgramFundingSourceCodeType->XmlSchemaType( bless( {
         ...
         'documentation' => bless( [
                                     ...
                                     bless( {
                                              'text' => 'Commonwealth Initiative'
                                            }, 'XML::Pastor::Schema::Documentation' ),
                                     bless( {
                                              'text' => 'School Source'
                                            }, 'XML::Pastor::Schema::Documentation' ),
                                     bless( {
                                              'text' => 'Director\'s Discretion'
                                            }, 'XML::Pastor::Schema::Documentation' ),
                                     bless( {
                                              'text' => 'Community Sponsored'
                                            }, 'XML::Pastor::Schema::Documentation' ),
                                     bless( {
                                              'text' => 'Other'
                                            }, 'XML::Pastor::Schema::Documentation' )
         ...
         'name' => 'AUCodeSetsProgramFundingSourceCodeType',
         'scope' => 'global',
...
B<SIF::AU::Type::AUCodeSetsProgramFundingSourceCodeType>  -  A class generated by L<XML::Pastor> . 
