...
package SIF::AU::Type::AssessmentSubTestType_ScoreRange;

use SIF::AU::Type::AUCodeSetsAssessmentReportingMethodType;

our @ISA=qw(XML::Pastor::ComplexType);

SIF::AU::Type::AssessmentSubTestType_ScoreRange->mk_accessors( qw(_ScoreMetric Minimum Maximum));

# Attribute accessor aliases

sub ScoreMetric { &_ScoreMetric; }

SIF::AU::Type::AssessmentSubTestType_ScoreRange->XmlSchemaType( bless( {
         'attributeInfo' => {
                              'ScoreMetric' => bless( {
         ...
         'isRedefinable' => 1,
         'metaClass' => 'SIF::AU::Pastor::Meta',
         'name' => 'AssessmentSubTestType_ScoreRange',
...
B<SIF::AU::Type::AssessmentSubTestType_ScoreRange>  -  A class generated by L<XML::Pastor> . 
