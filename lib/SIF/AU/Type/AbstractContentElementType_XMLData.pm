...
package SIF::AU::Type::AbstractContentElementType_XMLData;


our @ISA=qw(XML::Pastor::ComplexType);

SIF::AU::Type::AbstractContentElementType_XMLData->mk_accessors( qw(_Description));

# Attribute accessor aliases

sub Description { &_Description; }

SIF::AU::Type::AbstractContentElementType_XMLData->XmlSchemaType( bless( {
         'attributeInfo' => {
                              'Description' => bless( {
         ...
         'isRedefinable' => 1,
         'metaClass' => 'SIF::AU::Pastor::Meta',
         'name' => 'AbstractContentElementType_XMLData',
...
B<SIF::AU::Type::AbstractContentElementType_XMLData>  -  A class generated by L<XML::Pastor> . 
