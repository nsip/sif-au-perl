...
package SIF::AU::Type::SIF3AssessmentType_AssessmentIdentifiers_AssessmentIdentifier_AssessmentIdType;


our @ISA=qw(XML::Pastor::Builtin::token);

SIF::AU::Type::SIF3AssessmentType_AssessmentIdentifiers_AssessmentIdentifier_AssessmentIdType->XmlSchemaType( bless( {
         ...
         'name' => 'SIF3AssessmentType_AssessmentIdentifiers_AssessmentIdentifier_AssessmentIdType',
...
B<SIF::AU::Type::SIF3AssessmentType_AssessmentIdentifiers_AssessmentIdentifier_AssessmentIdType>  -  A class generated by L<XML::Pastor> . 
