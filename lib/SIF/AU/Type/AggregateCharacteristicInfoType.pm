...
package SIF::AU::Type::AggregateCharacteristicInfoType;
...
SIF::AU::Type::AggregateCharacteristicInfoType->mk_accessors( qw(_RefId Description Definition ElementName SIF_Metadata SIF_ExtendedElements));

# Attribute accessor aliases

sub RefId { &_RefId; }

SIF::AU::Type::AggregateCharacteristicInfoType->XmlSchemaType( bless( {
         'attributeInfo' => {
                              'RefId' => bless( {
                                                'class' => 'SIF::AU::Type::RefIdType',
                                                'documentation' => bless( [
                                                                            bless( {
                                                                                     'text' => 'Key for aggregate characteristic information.'
         ...
         'class' => 'SIF::AU::Type::AggregateCharacteristicInfoType',
         'contentType' => 'complex',
         'documentation' => bless( [
                                     bless( {
                                              'text' => 'This object defines the attribute of a group of objects that implicitly or explicitly defines a subset of the group.'
                                            }, 'XML::Pastor::Schema::Documentation' )
                                   ], 'Data::HashArray' ),
         'elementInfo' => {
                            'Definition' => bless( {
                                                   ...
                                                   'documentation' => bless( [
                                                                               bless( {
                                                                                        'text' => 'Defines the aggregate characteristic information.'
                                                                                      }, 'XML::Pastor::Schema::Documentation' )
                                                                             ], 'Data::HashArray' ),
                                                   'metaClass' => 'SIF::AU::Pastor::Meta',
                                                   'minOccurs' => '0',
      ...
      '
         ...
         'isRedefinable' => 1,
         'metaClass' => 'SIF::AU::Pastor::Meta',
         'name' => 'AggregateCharacteristicInfoType',
         'scope' => 'global',
         'targetNamespace' => 'http://www.SIFinfo.org/au/datamodel/1.3'
...
B<SIF::AU::Type::AggregateCharacteristicInfoType>  -  A class generated by L<XML::Pastor> . 
...
=item B<Definition>()      - See L<XML::Pastor::Builtin::token>.

=item B<Description>()      - See L<XML::Pastor::Builtin::string>.

=item B<ElementName>()      - See L<XML::Pastor::Builtin::token>.
