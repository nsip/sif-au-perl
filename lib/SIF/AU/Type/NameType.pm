...
SIF::AU::Type::NameType->mk_accessors( qw(_Type));

# Attribute accessor aliases

sub Type { &_Type; }

SIF::AU::Type::NameType->XmlSchemaType( bless( {
         'attributeInfo' => {
                              'Type' => bless( {
...
B<SIF::AU::Type::NameType>  -  A class generated by L<XML::Pastor> . 
