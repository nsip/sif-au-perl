...
package SIF::AU::Type::StudentSchoolEnrollmentType_Counselor_SIF_RefObject;


our @ISA=qw(XML::Pastor::Builtin::token);

SIF::AU::Type::StudentSchoolEnrollmentType_Counselor_SIF_RefObject->XmlSchemaType( bless( {
         ...
         'name' => 'StudentSchoolEnrollmentType_Counselor_SIF_RefObject',
...
B<SIF::AU::Type::StudentSchoolEnrollmentType_Counselor_SIF_RefObject>  -  A class generated by L<XML::Pastor> . 
