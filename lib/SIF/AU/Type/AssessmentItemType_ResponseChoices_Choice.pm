...
package SIF::AU::Type::AssessmentItemType_ResponseChoices_Choice;

use SIF::AU::Type::AbstractContentElementType;

our @ISA=qw(XML::Pastor::ComplexType);

SIF::AU::Type::AssessmentItemType_ResponseChoices_Choice->mk_accessors( qw(ChoiceLabel ChoiceContent CreditValue));

SIF::AU::Type::AssessmentItemType_ResponseChoices_Choice->XmlSchemaType( bless( {
         'attributeInfo' => {},
         'attributePrefix' => '_',
         'attributes' => [],
         'baseClasses' => [
      ...
      '
         ...
         'isRedefinable' => 1,
         'metaClass' => 'SIF::AU::Pastor::Meta',
         'name' => 'AssessmentItemType_ResponseChoices_Choice',
...
B<SIF::AU::Type::AssessmentItemType_ResponseChoices_Choice>  -  A class generated by L<XML::Pastor> . 
