...
package SIF::AU::Type::SIF_ReportObjectType_ReportInfo_SubmissionReason;


our @ISA=qw(XML::Pastor::Builtin::token);

SIF::AU::Type::SIF_ReportObjectType_ReportInfo_SubmissionReason->XmlSchemaType( bless( {
         ...
         'name' => 'SIF_ReportObjectType_ReportInfo_SubmissionReason',
...
B<SIF::AU::Type::SIF_ReportObjectType_ReportInfo_SubmissionReason>  -  A class generated by L<XML::Pastor> . 
