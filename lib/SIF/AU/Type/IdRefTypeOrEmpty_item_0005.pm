...
package SIF::AU::Type::IdRefTypeOrEmpty_item_0005;


our @ISA=qw(XML::Pastor::Builtin::string);

SIF::AU::Type::IdRefTypeOrEmpty_item_0005->XmlSchemaType( bless( {
         'base' => 'string|http://www.w3.org/2001/XMLSchema',
         'baseClasses' => [
                            'XML::Pastor::Builtin::string'
                          ],
         'class' => 'SIF::AU::Type::IdRefTypeOrEmpty_item_0005',
         'contentType' => 'simple',
         'derivedBy' => 'restriction',
         'isRedefinable' => 1,
         'length' => '0',
         'metaClass' => 'SIF::AU::Pastor::Meta',
         'name' => 'IdRefTypeOrEmpty_item_0005',
...
B<SIF::AU::Type::IdRefTypeOrEmpty_item_0005>  -  A class generated by L<XML::Pastor> . 
