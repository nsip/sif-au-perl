...
package SIF::AU::Type::AUCodeSetsSchoolEducationLevelTypeType;


our @ISA=qw(XML::Pastor::Builtin::token);

SIF::AU::Type::AUCodeSetsSchoolEducationLevelTypeType->XmlSchemaType( bless( {
         ...
         'documentation' => bless( [
                                     ...
                                     bless( {
                                              'text' => 'Year 9 or equivalent or below'
                                            }, 'XML::Pastor::Schema::Documentation' ),
                                     bless( {
         ...
         'name' => 'AUCodeSetsSchoolEducationLevelTypeType',
         'scope' => 'global',
...
B<SIF::AU::Type::AUCodeSetsSchoolEducationLevelTypeType>  -  A class generated by L<XML::Pastor> . 
