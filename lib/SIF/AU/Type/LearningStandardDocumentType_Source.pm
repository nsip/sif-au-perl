...
package SIF::AU::Type::LearningStandardDocumentType_Source;


our @ISA=qw(XML::Pastor::Builtin::token);

SIF::AU::Type::LearningStandardDocumentType_Source->XmlSchemaType( bless( {
         ...
         'name' => 'LearningStandardDocumentType_Source',
...
B<SIF::AU::Type::LearningStandardDocumentType_Source>  -  A class generated by L<XML::Pastor> . 
