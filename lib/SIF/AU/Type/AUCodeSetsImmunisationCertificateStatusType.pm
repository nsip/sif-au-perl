...
package SIF::AU::Type::AUCodeSetsImmunisationCertificateStatusType;


our @ISA=qw(XML::Pastor::Builtin::token);

SIF::AU::Type::AUCodeSetsImmunisationCertificateStatusType->XmlSchemaType( bless( {
         ...
         'name' => 'AUCodeSetsImmunisationCertificateStatusType',
         'scope' => 'global',
...
B<SIF::AU::Type::AUCodeSetsImmunisationCertificateStatusType>  -  A class generated by L<XML::Pastor> . 
