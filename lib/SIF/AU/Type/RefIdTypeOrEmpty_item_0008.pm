...
package SIF::AU::Type::RefIdTypeOrEmpty_item_0008;


our @ISA=qw(XML::Pastor::Builtin::string);

SIF::AU::Type::RefIdTypeOrEmpty_item_0008->XmlSchemaType( bless( {
         'base' => 'string|http://www.w3.org/2001/XMLSchema',
         'baseClasses' => [
                            'XML::Pastor::Builtin::string'
                          ],
         'class' => 'SIF::AU::Type::RefIdTypeOrEmpty_item_0008',
         'contentType' => 'simple',
         'derivedBy' => 'restriction',
         'isRedefinable' => 1,
         'length' => '0',
         'metaClass' => 'SIF::AU::Pastor::Meta',
         'name' => 'RefIdTypeOrEmpty_item_0008',
...
B<SIF::AU::Type::RefIdTypeOrEmpty_item_0008>  -  A class generated by L<XML::Pastor> . 
