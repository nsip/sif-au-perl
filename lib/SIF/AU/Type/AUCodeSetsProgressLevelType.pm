...
package SIF::AU::Type::AUCodeSetsProgressLevelType;


our @ISA=qw(XML::Pastor::Builtin::token);

SIF::AU::Type::AUCodeSetsProgressLevelType->XmlSchemaType( bless( {
         ...
         'name' => 'AUCodeSetsProgressLevelType',
         'scope' => 'global',
...
B<SIF::AU::Type::AUCodeSetsProgressLevelType>  -  A class generated by L<XML::Pastor> . 
