...
package SIF::AU::Type::LearningStandardDocumentType_DocumentStatus;


our @ISA=qw(XML::Pastor::Builtin::token);

SIF::AU::Type::LearningStandardDocumentType_DocumentStatus->XmlSchemaType( bless( {
         ...
         'name' => 'LearningStandardDocumentType_DocumentStatus',
...
B<SIF::AU::Type::LearningStandardDocumentType_DocumentStatus>  -  A class generated by L<XML::Pastor> . 
