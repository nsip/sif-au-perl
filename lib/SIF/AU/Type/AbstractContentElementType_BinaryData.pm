...
package SIF::AU::Type::AbstractContentElementType_BinaryData;

use SIF::AU::Type::XSBase64BinaryOrEmpty;

our @ISA=qw(SIF::AU::Type::XSBase64BinaryOrEmpty);

SIF::AU::Type::AbstractContentElementType_BinaryData->mk_accessors( qw(_MIMEType _FileName _Description));
...
SIF::AU::Type::AbstractContentElementType_BinaryData->XmlSchemaType( bless( {
         'attributeInfo' => {
                              'Description' => bless( {
         ...
         'isSimpleContent' => 1,
         'metaClass' => 'SIF::AU::Pastor::Meta',
         'name' => 'AbstractContentElementType_BinaryData',
...
B<SIF::AU::Type::AbstractContentElementType_BinaryData>  -  A class generated by L<XML::Pastor> . 
