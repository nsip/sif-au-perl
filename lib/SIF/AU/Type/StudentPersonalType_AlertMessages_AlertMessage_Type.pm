...
package SIF::AU::Type::StudentPersonalType_AlertMessages_AlertMessage_Type;


our @ISA=qw(XML::Pastor::Builtin::token);

SIF::AU::Type::StudentPersonalType_AlertMessages_AlertMessage_Type->XmlSchemaType( bless( {
         ...
         'name' => 'StudentPersonalType_AlertMessages_AlertMessage_Type',
...
B<SIF::AU::Type::StudentPersonalType_AlertMessages_AlertMessage_Type>  -  A class generated by L<XML::Pastor> . 
