...
package SIF::AU::Type::OtherNamesType_Name_SIF_Action;


our @ISA=qw(XML::Pastor::Builtin::token);

SIF::AU::Type::OtherNamesType_Name_SIF_Action->XmlSchemaType( bless( {
         ...
         'name' => 'OtherNamesType_Name_SIF_Action',
...
B<SIF::AU::Type::OtherNamesType_Name_SIF_Action>  -  A class generated by L<XML::Pastor> . 
