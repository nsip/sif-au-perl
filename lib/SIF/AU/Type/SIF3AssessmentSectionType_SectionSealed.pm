...
package SIF::AU::Type::SIF3AssessmentSectionType_SectionSealed;


our @ISA=qw(XML::Pastor::Builtin::token);

SIF::AU::Type::SIF3AssessmentSectionType_SectionSealed->XmlSchemaType( bless( {
         ...
         'documentation' => bless( [
                                     bless( {
                                              'text' => 'Section is sealed.'
                                            }, 'XML::Pastor::Schema::Documentation' ),
                                     bless( {
                                              'text' => 'Section is not sealed.'
                                            }, 'XML::Pastor::Schema::Documentation' )
                                   ], 'Data::HashArray' ),
         'enumeration' => {
                            'n' => 1,
         ...
         'name' => 'SIF3AssessmentSectionType_SectionSealed',
...
B<SIF::AU::Type::SIF3AssessmentSectionType_SectionSealed>  -  A class generated by L<XML::Pastor> . 
