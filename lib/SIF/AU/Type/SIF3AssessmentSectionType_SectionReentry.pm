...
package SIF::AU::Type::SIF3AssessmentSectionType_SectionReentry;


our @ISA=qw(XML::Pastor::Builtin::token);

SIF::AU::Type::SIF3AssessmentSectionType_SectionReentry->XmlSchemaType( bless( {
         ...
         'documentation' => bless( [
                                     bless( {
                                              'text' => 'Section can be re-entered.'
                                            }, 'XML::Pastor::Schema::Documentation' ),
                                     bless( {
                                              'text' => 'Section cannot be reentered.'
                                            }, 'XML::Pastor::Schema::Documentation' )
                                   ], 'Data::HashArray' ),
         'enumeration' => {
                            'n' => 1,
         ...
         'name' => 'SIF3AssessmentSectionType_SectionReentry',
...
B<SIF::AU::Type::SIF3AssessmentSectionType_SectionReentry>  -  A class generated by L<XML::Pastor> . 
