...
package SIF::AU::Type::AbstractContentElementType_Reference;


our @ISA=qw(XML::Pastor::ComplexType);

SIF::AU::Type::AbstractContentElementType_Reference->mk_accessors( qw(_MIMEType _Description URL));
...
SIF::AU::Type::AbstractContentElementType_Reference->XmlSchemaType( bless( {
         'attributeInfo' => {
                              'Description' => bless( {
         ...
         'isRedefinable' => 1,
         'metaClass' => 'SIF::AU::Pastor::Meta',
         'name' => 'AbstractContentElementType_Reference',
...
B<SIF::AU::Type::AbstractContentElementType_Reference>  -  A class generated by L<XML::Pastor> . 
