...
package SIF::AU::Type::AbstractContentElementType_TextData;


our @ISA=qw(XML::Pastor::Builtin::string);

SIF::AU::Type::AbstractContentElementType_TextData->mk_accessors( qw(_MIMEType _FileName _Description));
...
SIF::AU::Type::AbstractContentElementType_TextData->XmlSchemaType( bless( {
         'attributeInfo' => {
                              'Description' => bless( {
         ...
         'isSimpleContent' => 1,
         'metaClass' => 'SIF::AU::Pastor::Meta',
         'name' => 'AbstractContentElementType_TextData',
...
B<SIF::AU::Type::AbstractContentElementType_TextData>  -  A class generated by L<XML::Pastor> . 
