...
package SIF::AU::Type::AssessmentItemType_PerformanceLevels_PerformanceLevel_CutScores;

use SIF::AU::Type::AUCodeSetsAssessmentReportingMethodType;

our @ISA=qw(XML::Pastor::ComplexType);

SIF::AU::Type::AssessmentItemType_PerformanceLevels_PerformanceLevel_CutScores->mk_accessors( qw(_ScoreMetric LowerCut UpperCut));

# Attribute accessor aliases

sub ScoreMetric { &_ScoreMetric; }

SIF::AU::Type::AssessmentItemType_PerformanceLevels_PerformanceLevel_CutScores->XmlSchemaType( bless( {
         'attributeInfo' => {
                              'ScoreMetric' => bless( {
         ...
         'isRedefinable' => 1,
         'metaClass' => 'SIF::AU::Pastor::Meta',
         'name' => 'AssessmentItemType_PerformanceLevels_PerformanceLevel_CutScores',
...
B<SIF::AU::Type::AssessmentItemType_PerformanceLevels_PerformanceLevel_CutScores>  -  A class generated by L<XML::Pastor> . 
