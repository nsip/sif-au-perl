...
package SIF::AU::Type::OtherCodeListType;

use SIF::AU::Type::OtherCodeListType_OtherCode;

our @ISA=qw(XML::Pastor::ComplexType);

SIF::AU::Type::OtherCodeListType->mk_accessors( qw(OtherCode));

SIF::AU::Type::OtherCodeListType->XmlSchemaType( bless( {
         'attributeInfo' => {},
         'attributePrefix' => '_',
         'attributes' => [],
         'baseClasses' => [
      ...
      '
                                                  ...
                                                  'type' => 'OtherCodeListType_OtherCode|http://www.SIFinfo.org/au/datamodel/1.3'
...
B<SIF::AU::Type::OtherCodeListType>  -  A class generated by L<XML::Pastor> . 
...
=item B<OtherCode>()      - See L<SIF::AU::Type::OtherCodeListType_OtherCode>.
