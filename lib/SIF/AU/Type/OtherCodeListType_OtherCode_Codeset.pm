...
package SIF::AU::Type::OtherCodeListType_OtherCode_Codeset;


our @ISA=qw(XML::Pastor::Builtin::token);

SIF::AU::Type::OtherCodeListType_OtherCode_Codeset->XmlSchemaType( bless( {
         ...
         'name' => 'OtherCodeListType_OtherCode_Codeset',
...
B<SIF::AU::Type::OtherCodeListType_OtherCode_Codeset>  -  A class generated by L<XML::Pastor> . 
