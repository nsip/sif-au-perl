...
package SIF::AU::Type::HomeroomNumberType;


our @ISA=qw(XML::Pastor::Builtin::normalizedString);

SIF::AU::Type::HomeroomNumberType->XmlSchemaType( bless( {
...
B<SIF::AU::Type::HomeroomNumberType>  -  A class generated by L<XML::Pastor> . 
