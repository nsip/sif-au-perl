...
package SIF::AU::Type::AUCodeSetsSchoolSystemType;


our @ISA=qw(XML::Pastor::Builtin::token);

SIF::AU::Type::AUCodeSetsSchoolSystemType->XmlSchemaType( bless( {
         ...
         'name' => 'AUCodeSetsSchoolSystemType',
         'scope' => 'global',
...
B<SIF::AU::Type::AUCodeSetsSchoolSystemType>  -  A class generated by L<XML::Pastor> . 
