...
package SIF::AU::Type::AUCodeSetsActivityTypeType;


our @ISA=qw(XML::Pastor::Builtin::token);

SIF::AU::Type::AUCodeSetsActivityTypeType->XmlSchemaType( bless( {
         ...
         'name' => 'AUCodeSetsActivityTypeType',
         'scope' => 'global',
...
B<SIF::AU::Type::AUCodeSetsActivityTypeType>  -  A class generated by L<XML::Pastor> . 
