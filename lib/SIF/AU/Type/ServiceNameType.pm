...
package SIF::AU::Type::ServiceNameType;


our @ISA=qw(XML::Pastor::Builtin::NCName);

SIF::AU::Type::ServiceNameType->XmlSchemaType( bless( {
         'base' => 'NCName|http://www.w3.org/2001/XMLSchema',
         'baseClasses' => [
                            'XML::Pastor::Builtin::NCName'
                          ],
         'class' => 'SIF::AU::Type::ServiceNameType',
         'contentType' => 'simple',
         'derivedBy' => 'restriction',
         'documentation' => bless( [
                                     bless( {
                                              'text' => 'An unenumerated SIF object name.'
...
B<SIF::AU::Type::ServiceNameType>  -  A class generated by L<XML::Pastor> . 
