...
package SIF::AU::Type::AbstractContentPackageType_XMLData;


our @ISA=qw(XML::Pastor::ComplexType);

SIF::AU::Type::AbstractContentPackageType_XMLData->mk_accessors( qw(_Description));

# Attribute accessor aliases

sub Description { &_Description; }

SIF::AU::Type::AbstractContentPackageType_XMLData->XmlSchemaType( bless( {
         'attributeInfo' => {
                              'Description' => bless( {
        ...
        '
         ...
         'isRedefinable' => 1,
         'metaClass' => 'SIF::AU::Pastor::Meta',
         'name' => 'AbstractContentPackageType_XMLData',
...
B<SIF::AU::Type::AbstractContentPackageType_XMLData>  -  A class generated by L<XML::Pastor> . 
