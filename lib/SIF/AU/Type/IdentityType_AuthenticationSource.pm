...
package SIF::AU::Type::IdentityType_AuthenticationSource;


our @ISA=qw(XML::Pastor::Builtin::token);

SIF::AU::Type::IdentityType_AuthenticationSource->XmlSchemaType( bless( {
         ...
         'name' => 'IdentityType_AuthenticationSource',
...
B<SIF::AU::Type::IdentityType_AuthenticationSource>  -  A class generated by L<XML::Pastor> . 
