...
package SIF::AU::Type::ActivityType_Evaluation_EvaluationType;


our @ISA=qw(XML::Pastor::Builtin::token);

SIF::AU::Type::ActivityType_Evaluation_EvaluationType->XmlSchemaType( bless( {
         ...
         'name' => 'ActivityType_Evaluation_EvaluationType',
...
B<SIF::AU::Type::ActivityType_Evaluation_EvaluationType>  -  A class generated by L<XML::Pastor> . 
