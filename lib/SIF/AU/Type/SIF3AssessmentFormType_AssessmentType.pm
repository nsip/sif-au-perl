...
package SIF::AU::Type::SIF3AssessmentFormType_AssessmentType;


our @ISA=qw(XML::Pastor::Builtin::token);

SIF::AU::Type::SIF3AssessmentFormType_AssessmentType->XmlSchemaType( bless( {
         ...
         'name' => 'SIF3AssessmentFormType_AssessmentType',
...
B<SIF::AU::Type::SIF3AssessmentFormType_AssessmentType>  -  A class generated by L<XML::Pastor> . 
