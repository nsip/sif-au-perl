...
package SIF::AU::Type::SIF3StudentResponseSetType_Items_Item_AttemptStatus;


our @ISA=qw(XML::Pastor::Builtin::token);

SIF::AU::Type::SIF3StudentResponseSetType_Items_Item_AttemptStatus->XmlSchemaType( bless( {
         ...
         'name' => 'SIF3StudentResponseSetType_Items_Item_AttemptStatus',
...
B<SIF::AU::Type::SIF3StudentResponseSetType_Items_Item_AttemptStatus>  -  A class generated by L<XML::Pastor> . 
